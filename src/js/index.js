...
// Form submission
document.querySelector('.js-location-form').addEventListener('submit', function (e) {
    e.preventDefault();
...
document.querySelector('.js-change-location-btn').addEventListener('click', function () {
